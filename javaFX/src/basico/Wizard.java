...
public class Wizard extends Application {
	...
	private void criarPasso1() {
		Button proximoPasso = new Button("Avançar para o passo 2");
	...
	private void criarPasso2() {
		...
		Button voltar = new Button("Voltar para o passo 1");
		voltar.setOnAction(e -> {
			janela.setScene(passo1);
			janela.setTitle("Wizard - Passo 1");
		});
		
		Button proximoPasso = new Button("Avançar para o passo 3");
		proximoPasso.setOnAction(e -> {
	...
	private void criarPasso3() {
		...
		Button voltar = new Button("Voltar para o passo 2");
		voltar.setOnAction(e -> {
			janela.setScene(passo2);
			janela.setTitle("Wizard - Passo 2");
		});
